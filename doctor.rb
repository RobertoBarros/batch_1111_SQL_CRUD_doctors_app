class Doctor
  ...
  # Método de Classe
  # Retorna uma única instância de doctor pelo id
  def self.find(id)
  ...
  # Método de instância que apaga um record pelo @id
  def destroy
  ...
  # Se o @id é nil é uma instância que deve ter os dados inseridos no database
  def save
    @id ? update : create
  end
